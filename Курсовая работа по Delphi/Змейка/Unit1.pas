...
begin
 // Зацикливание музыки
  ...
  MediaPlayer1.Notify := True; // Включаем уведомления снова
end;
...
begin
 ShowMessage('Автор: Евгений Дашкевич');
end;
...
begin
  ...
  // Конвертация значения громкости в диапазон для waveOutSetVolume
  ConvertedVolume := Round((Volume / Form4.ScrollBar1.Max) * $FFFF);

  // Установка громкости для обоих каналов (левого и правого)
